...
import type { UpdateEntry, UpdateKind, UpdateTopic } from '../types'
...
function UpdateCard({ update, featured }: { update: UpdateEntry; featured?: boolean }) {
  return (
    <a
      href={update.url}
      target="_blank"
    ...
    >
      <div className="flex items-start justify-between gap-3">
        <h3 className="font-medium leading-snug text-ink group-hover:text-accent-strong">
          {update.title}
        </h3>
      ...
      <p className="mt-1.5 text-xs text-ink-muted">
        <span
          className={clsx(
            'mr-1.5 rounded px-1.5 py-0.5 font-mono text-[10px]',
